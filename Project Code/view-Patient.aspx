<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view-Patient.aspx.cs" Inherits="view_Patient" %>
...
<div class="clear" style="margin-top:20px ; margin-left:100px"> 
        <asp:Button ID="btnShowAll" runat="server" type="submit" class="view-btn" Width="10%" Text="show all" OnClick="btnShowAll_Click" />
    		...
    		<div class="grid-view" style="width=100%"> 
    		    ...
    		    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Patient]">
                </asp:SqlDataSource>
    		</div>
...
<!-- copy from here-->
    		...
    		<div class="grid-view"> 
    			<div class="lable">
                    ...
                    <asp:Label ID="Label1" runat="server" Style="font-size:20px" Text="The Patient Who Made The Maximum Number Of Orders:" ForeColor="White"></asp:Label>
				...
				<div class="report-grid" id="printableArea" style="margin-top:20px ; margin-left:100px"> 
				    ...
				    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SP_Patient_Max_Orders" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
				</div>
