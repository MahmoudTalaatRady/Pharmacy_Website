<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-Salesman.aspx.cs" Inherits="add_Salesman" %>
      ...
      <h2>Signup</h2>
		   ...
		   <div class="lable-2">
		        <asp:TextBox ID="txtEmail" runat="server" CssClass="text" placeholder="Email" ></asp:TextBox> 
		     	<asp:TextBox ID="txtAddress" runat="server" CssClass="text" placeholder="Address" style="margin-bottom:40px"></asp:TextBox> 
                
		   </div>
               <div class="lable"> 
		        <div class="col_1_of_2 span_1_of_2" style="margin-right:0px ; padding-right:0px ; text-align:center ; font-size:17px ; padding-top:10px">	<asp:Label ID="Label1" runat="server" Text="Company" style="color:white;"></asp:Label>   </div>
                <div class="col_1_of_2 span_1_of_2">    <asp:DropDownList ID="drCompany" runat="server"  Height="50px" Width="383px" style="margin-left:0px" Font-Bold="True" Font-Size="Medium"  ForeColor="Gray" required>
                    </asp:DropDownList> <asp:Label ID="lbltryCatch" runat="server" ForeColor="#FF3300"></asp:Label>
		        </div>
                <div class="clear"> </div>
		   <div class="submit" style="margin-top:30px">
               <asp:Button ID="btnAddSalesman" runat="server" CssClass="submit" Text="Add Salesman" OnClick="btnAddSalesman_Click" />
		   </div>
		   <div class="clear"> </div>
		<!-----//end-main---->
		</div>
