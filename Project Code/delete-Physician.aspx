<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete-Physician.aspx.cs" Inherits="delete_Physician" %>
...
<div class="main">
		   ...
		   <div>
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Physician] WHERE (([ID] = @ID) OR ([Mobile] = @Mobile))">
                   <SelectParameters>
