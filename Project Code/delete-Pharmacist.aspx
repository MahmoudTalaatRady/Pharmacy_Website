<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete-Pharmacist.aspx.cs" Inherits="delete_Pharmacist" %>
...
<div class="main">
		   ...
		   <div>
               <asp:GridView ID="gvPharmacist" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" style="text-align:center ; Width: 800px ; font-size:20px">
		       ...
		       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Pharmacist] WHERE (([ID] = @ID) OR ([Mobile] = @Mobile))">
                   <SelectParameters>
