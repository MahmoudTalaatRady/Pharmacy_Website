<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete-Company.aspx.cs" Inherits="delete_Company" %>
...
<div class="main">
		   ...
		   <div>
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Pharma_Company] WHERE (([ID] = @ID) OR ([Mobile] = @Mobile))">
                   <SelectParameters>
