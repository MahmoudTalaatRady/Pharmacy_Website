<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view-Pharmacist.aspx.cs" Inherits="view_Pharmacist" %>
...
<div class="clear" style="margin-top:20px ; margin-left:100px"> 
        <asp:Button ID="btnShowAll" runat="server" type="submit" class="view-btn" Width="10%" Text="show all" OnClick="btnShowAll_Click" />
    		...
    		<div class="grid-view" style="width=100%"> 
    		    ...
    		    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Pharmacist]" DeleteCommand="DELETE FROM [TBL_Pharmacist] WHERE [ID] = @ID" InsertCommand="INSERT INTO [TBL_Pharmacist] ([First_Name], [Surname], [Age], [Mobile], [Email], [Address], [Password]) VALUES (@First_Name, @Surname, @Age, @Mobile, @Email, @Address, @Password)" UpdateCommand="UPDATE [TBL_Pharmacist] SET [First_Name] = @First_Name, [Surname] = @Surname, [Age] = @Age, [Mobile] = @Mobile, [Email] = @Email, [Address] = @Address, [Password] = @Password WHERE [ID] = @ID">
                    <DeleteParameters>
...
<!-- copy from here-->
    		...
    		<div class="grid-view"> 
    			<div class="lable">
                    ...
                    <asp:Label ID="Label1" runat="server" Style="font-size:20px" Text="The Pharmacist Who Made The Maximum Number Of Orders:" ForeColor="White"></asp:Label>
				...
				<div class="report-grid" id="printableArea" style="margin-top:20px ; margin-left:100px"> 
				    ...
				    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SP_Pharmacist_Max_Orders" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
				</div>
