<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-Company.aspx.cs" Inherits="add_Comany" %>
...
<div class="main">
      <h2>Signup</h2>
		   <div class="lable"> 
		        <div class="col_1_of_2 span_1_of_2" style="margin-left:200px">	<asp:TextBox ID="txtName" runat="server" CssClass="text" placeholder="Name" required ></asp:TextBox></div>
                <div class="col_1_of_2 span_1_of_2">     </div>
                <div class="clear"> </div>

                 <div class="lable">
		        <div class="col_1_of_2 span_1_of_2" style="margin-left:200px">	
		        	<asp:TextBox ID="txtMobile" runat="server" CssClass="text" placeholder="Mobile" ></asp:TextBox> 
		        </div>
		   ...
		   <div class="submit">
               <asp:Button ID="btnAddCompany" runat="server" CssClass="submit" Text="Add Company" OnClick="btnAddCompany_Click" />
		   </div>
		   <div class="clear"> </div>
		<!-----//end-main---->
		</div>
