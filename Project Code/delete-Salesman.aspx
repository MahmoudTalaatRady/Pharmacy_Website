<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete-Salesman.aspx.cs" Inherits="delete_Salesman" %>
...
<div class="main">
		   ...
		   <div style="margin-left:250px">
               <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" style="text-align:center ; Width: 1300px ; font-size:20px">
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Salesman] WHERE (([ID] = @ID) OR ([Mobile] = @Mobile))">
                   <SelectParameters>
