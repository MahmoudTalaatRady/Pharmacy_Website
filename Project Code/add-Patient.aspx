<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-Patient.aspx.cs" Inherits="add_Patient" %>
    ...
    <div class="header">
				...
				<div class="contact-info">
					<ul>
                        ...
                        <asp:Button ID="btnLogout" runat="server"  type="submit" CssClass="float" Text="Logout" OnClick="btnLogin_Click" />
				</div>
				<div class="clear"> </div>
				</div>
			</div>
...
<div class="main">
      <h2>Signup</h2>
		   ...
		   <div class="submit">
               <asp:Button ID="btnAddPatient" runat="server" CssClass="submit" Text="Add Patient" OnClick="btnAddPatient_Click" />
		   </div>
		   <div class="clear"> </div>
		<!-----//end-main---->
		</div>
