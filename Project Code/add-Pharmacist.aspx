<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add-Pharmacist.aspx.cs" Inherits="add_Pharmacist" %>
...
<div class="main">
      <h2>Signup</h2>
		   ...
		   <div class="lable-2">
		        ...
		        <asp:TextBox ID="txtPassword" runat="server" type="password" CssClass="text" placeholder="Passworod" required></asp:TextBox> 
		   </div>
		   <div class="submit">
               <asp:Button ID="btnAddPharmacist" runat="server" CssClass="submit" Text="Add Pharmacist" OnClick="btnAddPharmacist_Click" />
		   </div>
		   <div class="clear"> </div>
		<!-----//end-main---->
		</div>
