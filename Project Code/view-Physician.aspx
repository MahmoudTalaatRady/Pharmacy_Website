<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view-Physician.aspx.cs" Inherits="view_Physician" %>
...
<div class="clear" style="margin-top:20px ; margin-left:100px"> 
        <asp:Button ID="btnShowAll" runat="server" type="submit" class="view-btn" Width="10%" Text="show all" OnClick="btnShowAll_Click" />
    		...
    		<div class="grid-view" style="width=100%"> 
    		    ...
    		    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Physician]">
                </asp:SqlDataSource>
    		</div>
...
<!-- copy from here-->
    		...
    		<div class="grid-view"> 
    			<div class="lable">
                    ...
                    <asp:Label ID="Label1" runat="server" Style="font-size:20px" Text="The Physician Who Made The Maximum Number Of Orders:" ForeColor="White"></asp:Label>
				...
				<div class="report-grid" id="printableArea" style="margin-top:20px ; margin-left:100px"> 
				    ...
				    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SP_Physician_Max_Orders" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
				</div>
        ...
        <!-- copy from here-->
    		...
    		<div class="grid-view"> 
    			<div class="lable">
                    ...
                    <asp:Label ID="Label2" runat="server" Style="font-size:20px" Text="The Physician Who Made Orders With Q Number Or More:" ForeColor="White"></asp:Label>
                                        <asp:Button ID="Button1" runat="server" type="submit" Text="Make Report" Width="20%" style="margin-left:160px" OnClick="Button1_Click" />

                    <asp:TextBox ID="txtQ1" runat="server" type="text" class="text" placeholder="Q">
                    </asp:TextBox>
				...
				<div class="report-grid" id="printableArea1" style="margin-top:20px ; margin-left:100px"> 
                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource3" style="text-align:center ; Width: 100% ; font-size:20px" ForeColor="#333333" GridLines="None">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:BoundField DataField="Physician ID" HeaderText="Physician ID" SortExpression="Physician ID" />
                            <asp:BoundField DataField="Physician Name" HeaderText="Physician Name" ReadOnly="True" SortExpression="Physician Name" />
                            <asp:BoundField DataField="Drug ID" HeaderText="Drug ID" SortExpression="Drug ID" />
                            <asp:BoundField DataField="Drug Name" HeaderText="Drug Name" SortExpression="Drug Name" />
                            <asp:BoundField DataField="No. of Orders" HeaderText="No. of Orders" ReadOnly="True" SortExpression="No. of Orders" />
				    ...
				    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SP_Company_Physician_Orders_Group" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="txtQ1" Name="Number_of_Orders" PropertyName="Text" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
				</div>

             	<button type="button" onclick="printDiv('printableArea1')" class="print-btn" >print report</button>
