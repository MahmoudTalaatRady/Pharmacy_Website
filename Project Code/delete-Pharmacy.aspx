<%@ Page Language="C#" AutoEventWireup="true" CodeFile="delete-Pharmacy.aspx.cs" Inherits="delete_Pharmacy" %>
...
<div class="main">
		   ...
		   <div>
               ...
               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Pharmacy_Order] WHERE (([ID] = @ID))">
                   <SelectParameters>
