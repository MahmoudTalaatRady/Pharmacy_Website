<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view-Pharmacy.aspx.cs" Inherits="view_Pharmacy" %>
...
<!-- copy from here-->
         ...
         <asp:Button ID="btnMakeReport"  type="submit" runat="server" Text="Show All" Width="20%" style="margin-left:650px" OnClick="btnMakeReport_Click" />
    		<div class="grid-view"> 
    			<div class="lable">
    		...
    		<hr>
				...
				<div class="report-grid" id="printableArea" style="margin-top:20px ; margin-left:100px"> 
                    <asp:GridView ID="GridView2" runat="server" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" style="text-align:center ; Width: 100% ; font-size:20px" AutoGenerateColumns="False" DataKeyNames="ID">
                        <AlternatingRowStyle BackColor="White" />
                        <Columns>
                            <asp:BoundField DataField="ID" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="ID" />
                            <asp:BoundField DataField="Patient_ID" HeaderText="Patient_ID" SortExpression="Patient_ID" />
                            <asp:BoundField DataField="Pharmacist_ID" HeaderText="Pharmacist_ID" SortExpression="Pharmacist_ID" />
                            <asp:BoundField DataField="Physician_ID" HeaderText="Physician_ID" SortExpression="Physician_ID" />
                            <asp:BoundField DataField="Drug_ID" HeaderText="Drug_ID" SortExpression="Drug_ID" />
				    ...
				    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TestPharmacyConnectionString %>" SelectCommand="SELECT * FROM [TBL_Pharmacy_Order]"></asp:SqlDataSource>
				</div>
