...
public partial class add_Physician : System.Web.UI.Page
{
    ...
    protected void btnAddPhysician_Click(object sender, EventArgs e)
    {
        ...
        command.CommandText = "SP_Physician_Insert";
        ...
        int row_affected1 = command.ExecuteNonQuery();
